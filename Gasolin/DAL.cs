    ...
    namespace Gasolin.models
    {
        ...
        public static void AddRefuel(Refuel refuel)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Debug prints
                Console.WriteLine("AddRefuel Method:");
                Console.WriteLine($"TimeStamp: {refuel.TimeStamp}");
                Console.WriteLine($"Liters: {refuel.Liters}");
                Console.WriteLine($"CurrentKm: {refuel.CurrentKm}");
                Console.WriteLine($"AmountEuro: {refuel.AmountEuro}");
                Console.WriteLine($"VehicleId: {refuel.VehicleId}");
                Console.WriteLine($"PersonId: {refuel.PersonId}");
